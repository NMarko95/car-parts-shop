...
const Vehicle = ({ setCategories, setSubCategories }) => {
  ...
  const handleChangeType = (type) => {
    ...
    const getBrand = async () => {
      const { data } = await axios.get(
        "https://localhost:7236/Vehicle/GetBrands"
      );
      //console.log(data);
      setIsClicked({
        index: "",
  ...
  const handleChangeBrand = (brand) => {
    ...
    const getModels = async () => {
      const { data } = await axios.get(
        `https://localhost:7236/Vehicle/GetModel/${brand}`
      );
      setIsClicked({
        index: "",
        value: false,
  ...
  const handleChangeModel = (model) => {
    ...
    const getSeries = async () => {
      const { data } = await axios.get(
        `https://localhost:7236/Vehicle/GetSeries/${selectedBrand}/${model}`
      );
      console.log(data);
      setIsClicked({
        index: "",
  ...
  const handleChangeSerie = (serie) => {
    ...
    const getEngineTypes = async () => {
      const { data } = await axios.get(
        `https://localhost:7236/Vehicle/GetEngine/${selectedBrand}/${selectedModel}/${serie}`
      );
