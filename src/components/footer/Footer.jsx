      ...
      <div className="footer-main">
        <div className="footer-container">
          ...
          <div className="footer-contact-item">
            ...
            <span className="footer-span">Belo Vrelo 1, 11030 Beograd</span>
          </div>
          <div className="footer-contact-item">
            <EmailOutlinedIcon style={iconStyles} />
            <span className="footer-span">info@prodajadelova.rs</span>
          </div>
          <div className="footer-contact-item">
            <LocalPhoneIcon style={iconStyles} />
            <span className="footer-span">011 43 000 45</span>
          </div>
        </div>
        <div className="footer-container">
